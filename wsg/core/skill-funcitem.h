...
DSK(BAZHEN, "八阵", JNL_LOCKED, "");
DSK(BEIGE, "悲歌", 0, "");
DSK(BENGHUAI, "崩坏", JNL_LOCKED, "");
DSK(BIYUE, "闭月", 0, "");
DSK(BUQU, "不屈", 0, "");
DSK(BUYI, "补益", 0, "");
DSK(CHONGZHEN, "冲阵", 0, "");
...
DSK(GONGJI, "弓骑", 0, "");
DSK(GONGXIN, "攻心", 0, "");
DSK(GUANXING, "观星", 0, "回合开始阶段，你可以观看牌堆顶的X张牌（X为存活角色的数量且最多为5），将其中任意数量的牌以任意顺序置于牌堆顶，其余以任意顺序置于牌堆底。");
DSK(GUHUO, "蛊惑", 0, "");
DSK(GUICAI, "鬼才", 0, "");
DSK(GUIDAO, "鬼道", 0, "");
DSK(GUIXIN, "归心", 0, "");
...
DSK(HUANSHI, "缓释", 0, "");
DSK(HUASHEN, "化身", 0, "");
DSK(HUILEI, "挥泪", JNL_LOCKED, "");
DSK(HUJIA, "护驾", JNL_MASTER, "主公技，当你需要使用（或打出）一张【闪】时，你可以发动护驾。所有“魏”势力角色按行动顺序依次选择是否打出一张【闪】“提供”给你（然后视为由你使用或打出），直到有—名角色或没有任何角色决定如此做时为止。");
DSK(HUNZHI, "魂姿", 0, "");
DSK(HUOJI, "火计", 0, "");
DSK(HUOSHOU, "祸首", JNL_LOCKED, "");
DSK(JIANG, "激昂", JNL_LOCKED, "");
DSK(JIANGCHI, "将驰", 0, "");
DSK(JIANXIONG, "奸雄", 0, "你可以立即获得对你成伤害的牌。");
DSK(JIE, "嫉恶", 0, "");
DSK(JIEFAN, "解烦", 0, "");
DSK(JIEMING, "节命", 0, "");
DSK(JIEYIN, "结姻", 0, "");
DSK(JIJIANG, "激将", JNL_MASTER, "主公技，当你需要使用（或打出）一张【杀】时，你可以发动激将。所有\"蜀\"势力角色按行动顺序依次选择是否打出一张【杀】\"提供\"给你（视为由你使用或打出），直到有一名角色或没有任何角色决定如此做时为止。");
...
DSK(JIZHI, "集智", 0, "");
DSK(JUEJING, "绝境", 0, "");
DSK(JUEQING, "绝情", JNL_LOCKED, "");
DSK(JUJIAN, "举荐", 0, "");
DSK(JUSHOU, "据守", 0, "");
DSK(JUXIANG, "巨象", 0, "");
DSK(KANPO, "看破", 0, "");
DSK(KEJI, "克己", 0, "");
DSK(KONGCHENG, "空城", JNL_LOCKED, "锁定技，当你没有手牌时，你不能成为【杀】或【决斗】的目标。");
DSK(KUANGBAO, "狂暴", 0, "");
DSK(KUANGFENG, "狂风", 0, "");
DSK(KUANGGU, "狂骨", 0, "");
DSK(KUIWEI, "溃围", 0, "");
...
DSK(LIJIAN, "离间", 0, "");
DSK(LIULI, "流离", 0, "");
DSK(LONGDAN, "龙胆", 0, "你可以将你手牌的【杀】当【闪】，【闪】当【杀】使用（或打出）。");
DSK(LONGHUN, "龙魂", 0, "");
DSK(LUANJI, "乱击", 0, "");
DSK(LUANWU, "乱武", 0, "");
DSK(LUOSHEN, "洛神", 0, "");
...
DSK(LUOYING, "落英", 0, "");
DSK(MANJUAN, "漫卷", 0, "");
DSK(MASHU, "马术", JNL_LOCKED, "锁定技，当你计算与其他角色的距离时，始终-1。", FS(distance_from));
DSK(MENGJIN, "猛进", 0, "");
DSK(MIJI, "秘计", 0, "");
DSK(MINGCE, "明策", 0, "");
DSK(MINGZHE, "明哲", 0, "");
DSK(MOUDAN, "谋断", 0, "");
DSK(NIEPAN, "涅槃", 0, "");
DSK(PAOXIAO, "咆哮", 0, "出牌阶段，你可以使用任意数量的【杀】。");
...
DSK(QUANJI, "权计", 0, "");
DSK(QUHU, "驱虎", 0, "");
DSK(RENDE, "仁德", 0, "出牌阶段，你可以将任意数量的手牌以任意分配方式交给其他角色，若你给出的牌张数不少于两张时，你回复1点体力。");
...
DSK(WUQIAN, "无前", 0, "");
DSK(WUSHEN, "武神", 0, "");
DSK(WUSHENG, "武圣", 0, "你可以将你的任意一张红色牌当【杀】使用或打出。");
DSK(WUSHUANG, "无双", 0, "");
DSK(WUYAN, "无言", 0, "");
DSK(XIANGLE, "享乐", 0, "");
DSK(XIANZHEN, "陷阵", 0, "");
